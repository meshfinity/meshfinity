...
pip install omegaconf pillow einops transformers trimesh "rembg[cpu]" vtk==9.3.1 moderngl pywebview requests huggingface-hub filelock wakepy miniaudio
...
# https://github.com/PowerShell/PowerShell/issues/18944#issuecomment-1382905172
cmd /c 'robocopy /E venv/Lib/site-packages/vtkmodules/util dist/Meshfinity/_internal/vtkmodules/util & exit 0'
