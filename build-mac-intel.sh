...
arch --x86_64 pip install omegaconf pillow einops transformers trimesh "rembg[cpu]" vtk==9.3.1 moderngl pywebview requests huggingface-hub filelock wakepy miniaudio
...
arch --x86_64 pip install pyinstaller==6.11.0
